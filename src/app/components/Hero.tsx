      ...
      <section className="home">
        <div className="home-detail">
          ...
          <h2>
            ...
            <span style={{ ['--i' as any]: 4 }} data-text="Web Developer">
              Web Developer
            </span>
            
            {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
            <span style={{ ['--i' as any]: 3 }} data-text="Front-End Developer">
              Front-End Developer
            </span>
            
            {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
            <span style={{ ['--i' as any]: 2 }} data-text="Web Designer">
              Web Designer
            </span>

            {/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
            <span style={{ ['--i' as any]: 1 }} data-text="UI/UX Designer">
              UI/UX Designer
            </span>
          </h2>
